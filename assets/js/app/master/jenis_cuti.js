...
window.MASTER = (function ($) {
	...
	var renderEdit = function (data, type, full, meta) {
		var url = APP.siteUrl + 'adm/jenis_cuti/edit/' + full['id'];
	...
	return {
		...
		urlDeleteData: window.APP.siteUrl + 'adm/jenis_cuti/delete',
		urlRequestData: window.APP.siteUrl + 'adm/jenis_cuti/get_data',
